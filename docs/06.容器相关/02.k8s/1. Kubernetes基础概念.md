...
<img src="https://raw.githubusercontent.com/daniuEvan/pictrues/main/Typora/1625452569657-833e64b2-1403-4fb6-9ee3-1e166504ccf0.png" alt="image.png" style="zoom: 33%;" />

> Kubernetes 为你提供了一个可弹性运行分布式系统的框架。 Kubernetes 会满足你的扩展要求、故障转移、部署模式等。 例如，Kubernetes 可以轻松管理系统的 Canary 部署。
>
>  Canary (金丝雀)部署- 体验服, 先将新功能开放给一部分人, 稳定之后全部开发
...
![image-20220706191436326](https://raw.githubusercontent.com/daniuEvan/pictrues/main/Typora/20220706191436.png)

### 2.1 控制平面组件 

- Control Plane Components: 控制平面的组件对集群做出全局决策(比如调度)，以及检测和响应集群事件（例如，当不满足部署的 `replicas` 字段时，启动新的 [pod](https://kubernetes.io/docs/concepts/workloads/pods/pod-overview/)）。
...
![image-20220706191441973](https://raw.githubusercontent.com/daniuEvan/pictrues/main/Typora/20220706191442.png)

# 二. 安装

> k3s 安装 https://www.cnblogs.com/lvlinguang/p/15679754.html#二在线安装
...
echo "10.120.11.35  cluster-endpoint" >> /etc/hosts


#主节点初始化
kubeadm init \
--apiserver-advertise-address=10.120.11.35 \
...
![image-20211224201554328](https://raw.githubusercontent.com/daniuEvan/pictrues/main/Typora/image-20211224201554328.png)

访问： https://集群任意node IP:端口 https://139.198.165.238:32759
...
![image-20220706191454738](https://raw.githubusercontent.com/daniuEvan/pictrues/main/Typora/20220706191454.png)
...
- calico/node is not ready: BIRD is not ready: BGP not established with
  ...
  https://blog.csdn.net/qq_37242520/article/details/108000007